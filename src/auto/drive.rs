...
pub trait DriveExt {
    ...
    //fn get_start_stop_type(&self) -> /*Ignored*/DriveStartStopType;

    #[cfg(any(feature = "v2_34", feature = "dox"))]
    fn get_symbolic_icon(&self) -> Option<Icon>;

    //fn get_volumes(&self) -> /*Ignored*/Vec<Volume>;
    ...
    //fn start<'a, 'b, 'c, P: Into<Option<&'a MountOperation>>, Q: Into<Option<&'b Cancellable>>, R: Into<Option<&'c /*Unimplemented*/AsyncReadyCallback>>, S: Into<Option</*Unimplemented*/Fundamental: Pointer>>>(&self, flags: /*Ignored*/DriveStartFlags, mount_operation: P, cancellable: Q, callback: R, user_data: S);
...
impl<O: IsA<Drive> + IsA<glib::object::Object>> DriveExt for O {
    ...
    //fn get_start_stop_type(&self) -> /*Ignored*/DriveStartStopType {
    //    unsafe { TODO: call ffi::g_drive_get_start_stop_type() }
    //}
    ...
    //fn get_volumes(&self) -> /*Ignored*/Vec<Volume> {
    //    unsafe { TODO: call ffi::g_drive_get_volumes() }
    //}
