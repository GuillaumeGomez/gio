...
pub trait FileExt {
    ...
    fn delete_async<'a, P: Into<Option<&'a Cancellable>>, Q: FnOnce(Result<(), Error>) + Send + 'static>(&self, io_priority: i32, cancellable: P, callback: Q);
    ...
    fn make_directory_async<'a, P: Into<Option<&'a Cancellable>>, Q: FnOnce(Result<(), Error>) + Send + 'static>(&self, io_priority: i32, cancellable: P, callback: Q);
    ...
    fn set_attributes_async<'a, P: Into<Option<&'a Cancellable>>, Q: FnOnce(Result<FileInfo, Error>) + Send + 'static>(&self, info: &FileInfo, flags: FileQueryInfoFlags, io_priority: i32, cancellable: P, callback: Q);
    ...
    #[cfg(any(feature = "v2_38", feature = "dox"))]
    fn trash_async<'a, P: Into<Option<&'a Cancellable>>, Q: FnOnce(Result<(), Error>) + Send + 'static>(&self, io_priority: i32, cancellable: P, callback: Q);
...
impl<O: IsA<File>> FileExt for O {
    ...
    fn delete_async<'a, P: Into<Option<&'a Cancellable>>, Q: FnOnce(Result<(), Error>) + Send + 'static>(&self, io_priority: i32, cancellable: P, callback: Q) {
        ...
        unsafe {
            ffi::g_file_delete_async(self.to_glib_none().0, io_priority, cancellable.0, Some(callback), Box::into_raw(user_data) as *mut _);
        }
    }
    ...
    fn make_directory_async<'a, P: Into<Option<&'a Cancellable>>, Q: FnOnce(Result<(), Error>) + Send + 'static>(&self, io_priority: i32, cancellable: P, callback: Q) {
        ...
        unsafe {
            ffi::g_file_make_directory_async(self.to_glib_none().0, io_priority, cancellable.0, Some(callback), Box::into_raw(user_data) as *mut _);
        }
    }
    ...
    fn set_attributes_async<'a, P: Into<Option<&'a Cancellable>>, Q: FnOnce(Result<FileInfo, Error>) + Send + 'static>(&self, info: &FileInfo, flags: FileQueryInfoFlags, io_priority: i32, cancellable: P, callback: Q) {
        ...
        unsafe {
            ffi::g_file_set_attributes_async(self.to_glib_none().0, info.to_glib_none().0, flags.to_glib(), io_priority, cancellable.0, Some(callback), Box::into_raw(user_data) as *mut _);
        }
    }
    ...
    fn trash_async<'a, P: Into<Option<&'a Cancellable>>, Q: FnOnce(Result<(), Error>) + Send + 'static>(&self, io_priority: i32, cancellable: P, callback: Q) {
        ...
        unsafe {
            ffi::g_file_trash_async(self.to_glib_none().0, io_priority, cancellable.0, Some(callback), Box::into_raw(user_data) as *mut _);
        }
    }
