...
impl ConverterOutputStream {
    //pub fn new<P: IsA<OutputStream>, Q: IsA</*Ignored*/Converter>>(base_stream: &P, converter: &Q) -> ConverterOutputStream {
    //    unsafe { TODO: call ffi::g_converter_output_stream_new() }
    //}
}
...
impl<O: IsA<ConverterOutputStream> + IsA<glib::object::Object>> ConverterOutputStreamExt for O {
    //fn get_converter(&self) -> /*Ignored*/Option<Converter> {
    //    unsafe { TODO: call ffi::g_converter_output_stream_get_converter() }
    //}
